...
// Tests that PYUSD Asset Protection capabilities function correctly.
contract('PYUSD', function ([_, admin, assetProtectionRole, otherAddress, freezableAddress, owner]) {
